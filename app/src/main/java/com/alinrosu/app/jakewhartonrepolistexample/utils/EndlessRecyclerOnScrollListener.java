...
public abstract class EndlessRecyclerOnScrollListener extends RecyclerView.OnScrollListener { //this is a recyclerView scroll listener that has a callback for when you reach the end of the list
